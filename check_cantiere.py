...
# Se non è già inizializzata dal main
try:
    db = firestore.client()
except Exception:
    initialize_app()
...
def check_cantiere():
    ...
    # Prendi gli ultimi job completati
    ...
    for doc in jobs:
        ...
        # Path atteso del JSON in Storage
        ...
        # Analizza un paio di delivery a campione (la prima e l'ultima)

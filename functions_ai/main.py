...
# Le librerie pesanti verranno caricate solo all'interno delle funzioni (lazy loading)
...
@https_fn.on_call(region="europe-west1", memory=options.MemoryOption.MB_512, timeout_sec=120, enforce_app_check=False, invoker="public")
...
@https_fn.on_call(region="europe-west1", timeout_sec=120, enforce_app_check=False, invoker="public")

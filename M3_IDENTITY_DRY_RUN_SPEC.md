...
- `M3_AUTH_CLASSIFICATION_DIAGNOSTIC.json`

## 8. PASSWORD POLICY
- `PASSWORD_FIELD`: `LEGACY_DEPRECATED_EXCLUDED`
- `PASSWORD_CLEANUP`: `DEFERRED_SEPARATE_OPERATION`
- Never report, copy or fingerprint password.

## 9. STATUS
SCRIPT IMPLEMENTED
FIRST_LIVE_DRY_RUN = NOT_CERTIFIED
RECONCILIATION_REQUIRED = TRUE
LIVE DRY RUN NOT YET EXECUTED
M3_WRITE_AUTHORIZED = FALSE

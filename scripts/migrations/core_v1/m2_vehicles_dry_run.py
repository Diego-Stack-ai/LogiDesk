...
class M2VehiclesDryRun:
    ...
    def read_source(self):
        ...
        for doc in mezzi_ref.stream():
            ...
            self.stats["legacy_vehicle_count"] += 1
    ...
    def process_vehicles(self):
        ...
        for item in self.legacy_data:
            ...
            if not targa_norm:
                ...
                self.stats["empty_targa_count"] += 1
            else:
                ...
                if norm_targas.get(targa_norm, 0) > 1:
                    ...
                    # Incrementing for each duplicate found
            ...
            if attivo is None:
                ...
                attivo_val = False # default for structure, but flagged
            else:
            ...
            optional_fields = ["tipo", "marca", "modello", "portata", "patente_richiesta", "temperatura", "note"]
    ...
    def write_outputs(self):
        ...
        summary = {
            ...
            "legacy_vehicle_count": self.stats["legacy_vehicle_count"],
            "simulated_target_count": len(self.target_preview),
            "ready_count": self.stats["ready_count"],
            "review_required_count": self.stats["review_required_count"],
            "error_count": self.stats["error_count"],
            "empty_targa_count": self.stats["empty_targa_count"],
        ...
        manifest = {
            "source_count": self.stats["legacy_vehicle_count"],
            "target_preview_count": len(self.target_preview),
